...
export default function Footer() {
  return (
    <footer className="relative" style={{ backgroundColor: "#0f3a6d" }}>
      <div className="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
        <div className="text-white space-y-8">
          <div className="flex justify-between gap-8 max-lg:flex-col">
            ...
            <div className="space-y-4">
              ...
              <p className="max-w-lg text-white !text-white">
            ...
            {/* Link columns */}
            <div className="flex gap-12 lg:gap-16 max-sm:flex-col max-sm:gap-8 shrink-0">
              ...
              <div className="flex flex-col gap-5">
                ...
                <div className="flex flex-col gap-3 text-white/80">
                  ...
                  <a href="/cookies" className="hover:text-white transition-colors duration-300">Política de Cookies</a>
                </div>
              </div>
            </div>
          </div>
