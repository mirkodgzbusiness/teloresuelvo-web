          ...
          <div className="nav-center">
            <ul className="nav-center__list">
              ...
              <li className="nav-mobile-social">
                <p className="nav-mobile-social__title">Síguenos en</p>
                <div className="nav-mobile-social__links">
                  <a href="https://www.instagram.com/teloresuelvoviajes/" target="_blank" rel="noopener noreferrer" className="nav-mobile-social__link">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="nav-mobile-social__icon">
                  ...
                  <a href="https://www.tiktok.com/@teloresuelvoviajes" target="_blank" rel="noopener noreferrer" className="nav-mobile-social__link">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="nav-mobile-social__icon">
                      <path d="M9 12a4 4 0 1 0 4 4V4a5 5 0 0 0 5 5" />
                    </svg>
                    <span>TikTok</span>
                  </a>
                  <a href="https://www.facebook.com/teloresuelvoIT" target="_blank" rel="noopener noreferrer" className="nav-mobile-social__link">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="nav-mobile-social__icon">
